...
export default function WritingTest() {
  ...
  const exampleKeywords = ["gentle", "breeze", "carried", "scent", "earth", "rain", "weaving", "quiet", "streets", "distant", "hum", "city", "life", "echoed", "background", "dim", "glow", "streetlights", "flickered", "softly", "casting", "long", "shadows", "stretched", "pavement", "soft", "golden", "light", "sun", "dipped", "below", "horizon", "painting", "sky", "streaks", "amber", "violet", "faint", "rustling", "sound", "came", "corner", "breaking", "stillness", "evening", "air"]; // 예시 단어들
  ...
  const [hasFeedbackStarted, setHasFeedbackStarted] = useState(false); // 피드백 시작 여부 상태 추가
