...
export default function WritingTest() {
  ...
  const exampleKeywords = ["gentle", "breeze", "scent", "earth", "rain", "weaving", "quiet", "streets", "distant", "hum", "city", "life", "echoed", "background", "dim", "glow", "streetlights", "flickered", "softly", "casting", "long", "shadows", "stretched", "pavement", "soft", "golden", "light", "sun", "dipped", "below", "horizon", "painting", "sky", "streaks", "amber", "violet", "faint", "rustling", "sound", "came", "corner", "breaking", "stillness", "evening", "air"]; // 예시 단어들
