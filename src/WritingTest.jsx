...
export default function WritingTest() {
  ...
  const fullText = "To maintain this style while developing your story into a more engaging narrative, it would be beneficial to describe the introduction in more detail. \n This will enhance the immersion of your story. I'll give you an example sentence below, so add it to your writing! \n \n ex 1) 'A gentle breeze carried the scent of earth and rain, weaving through the quiet streets as the distant hum of city life echoed in the background. \n The dim glow of streetlights flickered softly, casting long shadows that stretched across the pavement. \n ex 2) The room was filled with a soft, golden light as the sun dipped below the horizon, painting the sky with streaks of amber and violet. A faint rustling sound came from the corner, breaking the stillness of the evening air.'"; // 도움 내용(낮은 개인화)&예시시
